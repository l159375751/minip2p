(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function r(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=r(n);fetch(n.href,i)}})();const _=[{id:"gutenberg-11",title:"Alice's Adventures in Wonderland",author:"Lewis Carroll",size_kb:403,cover:"https://0x6d.net/minip2p/assets/alice.jpg",infohash:"sample-alice",nostr_event:"nostr:sample-alice",summary:"A curious girl falls through a rabbit hole into a world of whimsical logic."},{id:"gutenberg-84",title:"Frankenstein",author:"Mary Wollstonecraft Shelley",size_kb:512,cover:"https://0x6d.net/minip2p/assets/frankenstein.jpg",infohash:"sample-frankenstein",nostr_event:"nostr:sample-frankenstein",summary:"A scientist’s creation challenges the boundaries between life, death, and responsibility."},{id:"gutenberg-345",title:"Dracula",author:"Bram Stoker",size_kb:706,cover:"https://0x6d.net/minip2p/assets/dracula.jpg",infohash:"sample-dracula",nostr_event:"nostr:sample-dracula",summary:"Journal entries and letters chronicle the hunt for a night-walking count."},{id:"gutenberg-1342",title:"Pride and Prejudice",author:"Jane Austen",size_kb:723,cover:"https://0x6d.net/minip2p/assets/pride.jpg",infohash:"sample-pride",nostr_event:"nostr:sample-pride",summary:"Elizabeth Bennet learns to balance judgment with empathy amid regency-era society."},{id:"gutenberg-48320",title:"The Adventures of Sherlock Holmes",author:"Arthur Conan Doyle",size_kb:654,cover:"https://0x6d.net/minip2p/assets/sherlock.jpg",infohash:"sample-sherlock",nostr_event:"nostr:sample-sherlock",summary:"A dozen mysteries showcase Holmes’ deductive flair and Watson’s loyal narration."}],$=new Map;function x(e,t){const r=$.get(e);r&&r.forEach(a=>{try{a(t)}catch(n){console.error(`[event-bus] handler error on ${e}`,n)}})}function m(e){return new Promise((t,r)=>{e.oncomplete=e.onsuccess=()=>t(e.result),e.onabort=e.onerror=()=>r(e.error)})}function y(e,t){let r;const a=()=>{if(r)return r;const n=indexedDB.open(e);return n.onupgradeneeded=()=>n.result.createObjectStore(t),r=m(n),r.then(i=>{i.onclose=()=>r=void 0},()=>{}),r};return(n,i)=>a().then(o=>i(o.transaction(t,n).objectStore(t)))}let f;function b(){return f||(f=y("keyval-store","keyval")),f}function A(e,t=b()){return t("readonly",r=>m(r.get(e)))}function T(e,t,r=b()){return r("readwrite",a=>(a.put(t,e),m(a.transaction)))}const E="nostr-library-hub",z="state",u="library-items",p=typeof indexedDB<"u"?y(E,z):null,g=typeof window<"u"&&typeof window.localStorage<"u",w={parse(e,t){try{return JSON.parse(e)}catch{return t}},stringify(e,t="[]"){try{return JSON.stringify(e)}catch{return t}}},M=(e,t)=>g?w.parse(window.localStorage.getItem(e),t):t,I=(e,t)=>{g&&window.localStorage.setItem(e,w.stringify(t))};async function j(e,t){if(!p)return t;try{const r=await A(e,p);return typeof r>"u"?t:r}catch{return t}}async function C(e,t){if(p)try{await T(e,t,p)}catch{}}async function O(){const e=M(u,[]);return j(u,e)}async function v(e){const t=Array.isArray(e)?e:[];return I(u,t),await C(u,t),t}const s={manifest:_,library:[],initialized:!1},h=new Set;function S(){const e=l();h.forEach(t=>t(e)),x("state:update",e)}function l(){return{manifest:s.manifest,library:s.library,initialized:s.initialized}}function R(e){if(typeof e!="function")throw new TypeError("store.subscribe requires a function");return h.add(e),e(l()),()=>h.delete(e)}async function P(){s.library.length===0&&(s.library=s.manifest.slice(0,5).map(e=>({...e,addedAt:Date.now()})),await v(s.library))}async function B(){if(s.initialized)return l();const e=await O();return s.library=Array.isArray(e)?e:[],await P(),s.initialized=!0,S(),l()}async function D(e){const t=s.library.filter(r=>r.id!==e);return t.length===s.library.length||(s.library=t,await v(s.library),S()),l()}const F=["wss://tracker.openwebtorrent.com","wss://tracker.webtorrent.dev","wss://tracker.btorrent.xyz","wss://tracker.fastcast.nz","udp://tracker.opentrackr.org:1337","udp://open.demonoid.ch:6969","udp://tracker.torrent.eu.org:451","udp://exodus.desync.com:6969"],k=(e,t=F)=>{if(!e)return"";const r=t.map(a=>`&tr=${encodeURIComponent(a)}`).join("");return`magnet:?xt=urn:btih:${e}${r}`};function N(e,t){const r=e.infohash||"",a=r?k(r):"",n=a?`${a.slice(0,42)}...`:"n/a";return`
    <article class="library-card" data-id="${e.id}">
      ...
      <dl class="library-card__details">
        ...
        <div>
          <dt>Infohash</dt>
          <dd class="monospace" title="${r||"n/a"}">${r||"n/a"}</dd>
        </div>
        <div>
          <dt>Magnet Preview</dt>
          <dd class="monospace" title="${n}">${n}</dd>
        </div>
      </dl>
  ...
  `}function W(e,t){const r=[],a=t.library.length?t.library:t.manifest.slice(0,5);r.push("<section>"),r.push("<header><h2>Featured Shelves</h2><p>These are our own shared collections—trim them locally or open titles directly.</p></header>"),r.push('<div class="library-grid">'),r.push(a.map(n=>{const i=t.library.some(o=>o.id===n.id);return N(n,i)}).join("")),r.push("</div></section>"),e.innerHTML=r.join("")}function H(e,t){const r=e.target.dataset.action;if(!r)return;const{id:a}=e.target.dataset,n=t.library.find(c=>c.id===a),i=t.manifest.find(c=>c.id===a),o=n||i;if(o){if(r==="open"){const c=window.open("","_blank","noopener");c?(c.document.write(`
      ...
      `),c.document.close()):window.alert("Unable to open preview window (pop-up blocked).");return}if(r==="copy-magnet"){const c=k(o.infohash);if(!c){window.alert("Missing infohash for this entry.");return}if(navigator.clipboard?.writeText)navigator.clipboard.writeText(c);else{const d=document.createElement("textarea");d.value=c,document.body.appendChild(d),d.select(),document.execCommand("copy"),document.body.removeChild(d)}window.alert("Magnet copied to clipboard.");return}r==="save"||r==="remove"&&D(a)}}function J(e){if(!e)throw new Error("mountLibraryShelf requires a container element");let t=l();const r=n=>H(n,t);e.addEventListener("click",r);const a=R(n=>{t=n,W(e,n)});return()=>{e.removeEventListener("click",r),a()}}const L=document.querySelector("#app");if(!L)throw new Error('Root element #app was not found. Ensure index.html contains <div id="app"></div>.');L.innerHTML=`
...
`;const K=document.querySelector("#sample-shelf");(async()=>(await B(),J(K)))();
